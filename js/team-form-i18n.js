var TF_I18N = {
  fr: {
    ...
    defaultInviteMsg: 'Bonjour [Prénom],\n\n[Manager] vous invite à compléter votre profil pour l\'équipe « [Équipe] » sur Bloomday — l\'application qui aide les équipes à ne jamais manquer les moments importants de chacun 🎂\n\nC\'est rapide (2 min) et vos informations restent strictement confidentielles.\n\nFormulaire sécurisé :\n[LIEN]\n\n—\nBloomday · mybloomday.app',
  ...
  en: {
    ...
    defaultInviteMsg: 'Hi [First name],\n\n[Manager] is inviting you to complete your profile for the "[Team]" team on Bloomday — the app that helps teams never miss each other\'s important moments 🎂\n\nQuick to fill in (2 min) and your information stays strictly private.\n\nSecure form:\n[LINK]\n\n—\nBloomday · mybloomday.app',
