...
function exportPDF(){
  ...
  const now=new Date();
  let h=`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Bloomday — Export</title><style>body{font-family:Georgia,serif;max-width:720px;margin:40px auto;color:#2D1B14;font-size:14px}.header{display:flex;align-items:center;gap:16px;margin-bottom:24px;padding-bottom:16px;border-bottom:3px solid #D4A843}.logo{font-size:32px;font-weight:800;color:#D4A843}h2{font-size:16px;color:#7A5A10;margin:22px 0 8px;border-bottom:2px solid #D4A843;padding-bottom:4px}table{width:100%;border-collapse:collapse}th{background:#FDF6E3;color:#7A5A10;font-size:11px;padding:8px 10px;text-align:left;text-transform:uppercase}td{padding:8px 10px;border-bottom:1px solid #EEE0D4;font-size:12px}.tod{background:#FFF0EE;font-weight:bold}.footer{margin-top:40px;font-size:11px;color:#A89E90;text-align:center;border-top:1px solid #EEE0D4;padding-top:12px}</style></head><body>`;
  h+=`<div class="header"><div class="logo">🌸 Bloomday</div><div><div style="font-size:13px;color:#FF8C7A;font-style:italic">Le jour où tu fleuris</div><div style="font-size:12px;color:#8B6F60;margin-top:4px">Exporté le ${now.toLocaleDateString('fr-FR',{weekday:'long',day:'numeric',month:'long',year:'numeric'})}</div></div></div>`;
